...
$_['entry_category']     = 'Категории:<br/><span class="help">Отметьте категории из которых надо экспортировать предложения для Яндекс.Маркета.<br />Если ничего не отмечено, то будут выгружаться все категории.</span>';
...
$_['entry_product_rel'] = 'Выгружать сопутствующие товары в тэге &lt;rec&gt;:<br/><span class="help">Для Яндекс.Маркет</span>';
