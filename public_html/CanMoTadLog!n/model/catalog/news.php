...
class ModelCatalogNews extends Model {
	public function addNews($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "news SET date_available = '" . $this->db->escape($data['date_available']) . "', news_comments = '" . $this->db->escape($data['news_comments']) . "', ali = '" . $this->db->escape($data['ali']) . "', ozon = '" . $this->db->escape($data['ozon']) . "', status = '" . (int)$data['status'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_added = NOW()");
	...
	public function editNews($news_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "news SET date_available = '" . $this->db->escape($data['date_available']) . "', news_comments = '" . $this->db->escape($data['news_comments']) . "', ali = '" . $this->db->escape($data['ali']) . "', ozon = '" . $this->db->escape($data['ozon']) . "', status = '" . (int)$data['status'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_modified = NOW() WHERE news_id = '" . (int)$news_id . "'");
