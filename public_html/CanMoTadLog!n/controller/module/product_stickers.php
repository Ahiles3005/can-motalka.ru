...
class ControllerModuleProductStickers extends Controller {
	...
	public function index() {   
		...
		$this->data['entry_sticker_multiproduct'] = $this->language->get('entry_sticker_multiproduct');
		$this->data['entry_sticker_rcategory'] = $this->language->get('entry_sticker_rcategory');
		$this->data['entry_sticker_product_viewed'] = $this->language->get('entry_sticker_product_viewed');
		...
		//multiproduct
		if (isset($this->request->post['config_sticker_special_multiproduct'])) {
			$this->data['config_sticker_special_multiproduct'] = $this->request->post['config_sticker_special_multiproduct'];
		} else {
			$this->data['config_sticker_special_multiproduct'] = $this->config->get('config_sticker_special_multiproduct');
		}
		
		if (isset($this->request->post['config_sticker_new_multiproduct'])) {
			$this->data['config_sticker_new_multiproduct'] = $this->request->post['config_sticker_multiproduct'];
		} else {
			$this->data['config_sticker_new_multiproduct'] = $this->config->get('config_sticker_multiproduct');
		}
		
		if (isset($this->request->post['config_sticker_popular_multiproduct'])) {
			$this->data['config_sticker_popular_multiproduct'] = $this->request->post['config_sticker_popular_multiproduct'];
		} else {
			$this->data['config_sticker_popular_multiproduct'] = $this->config->get('config_sticker_popular_multiproduct');
		}
		
		//rcategory
		if (isset($this->request->post['config_sticker_special_rcategory'])) {
			$this->data['config_sticker_special_rcategory'] = $this->request->post['config_sticker_special_rcategory'];
		} else {
			$this->data['config_sticker_special_rcategory'] = $this->config->get('config_sticker_special_rcategory');
		}
		
		if (isset($this->request->post['config_sticker_new_rcategory'])) {
			$this->data['config_sticker_new_rcategory'] = $this->request->post['config_sticker_rcategory'];
		} else {
			$this->data['config_sticker_new_rcategory'] = $this->config->get('config_sticker_rcategory');
		}
		
		if (isset($this->request->post['config_sticker_popular_rcategory'])) {
			$this->data['config_sticker_popular_rcategory'] = $this->request->post['config_sticker_popular_rcategory'];
		} else {
			$this->data['config_sticker_popular_rcategory'] = $this->config->get('config_sticker_popular_rcategory');
		}
		
		//product_viewed
		if (isset($this->request->post['config_sticker_special_product_viewed'])) {
			$this->data['config_sticker_special_product_viewed'] = $this->request->post['config_sticker_special_product_viewed'];
		} else {
			$this->data['config_sticker_special_product_viewed'] = $this->config->get('config_sticker_special_product_viewed');
		}
		
		if (isset($this->request->post['config_sticker_new_product_viewed'])) {
			$this->data['config_sticker_new_product_viewed'] = $this->request->post['config_sticker_product_viewed'];
		} else {
			$this->data['config_sticker_new_product_viewed'] = $this->config->get('config_sticker_product_viewed');
		}
		
		if (isset($this->request->post['config_sticker_popular_product_viewed'])) {
			$this->data['config_sticker_popular_product_viewed'] = $this->request->post['config_sticker_popular_product_viewed'];
		} else {
			$this->data['config_sticker_popular_product_viewed'] = $this->config->get('config_sticker_popular_product_viewed');
		}
