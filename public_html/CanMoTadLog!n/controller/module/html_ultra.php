...
class ControllerModuleHtmlUltra extends Controller {
	...
	public function index() {   
		...
		$this->document->addScript('https://code.jquery.com/jquery-migrate-1.0.0.js');
...
//---------- Доп настройки --------------//		  
		...
		usort($manufacturer_info_sort, "cmp");
