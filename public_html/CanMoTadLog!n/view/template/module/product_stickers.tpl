      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<table class="list">
		  ...
		  <tbody>
			...
			<tr>
			  <td class="left"><?php echo $entry_sticker_multiproduct; ?></td>
			  <td class="center"><select name="config_sticker_special_multiproduct">
                <?php if ($config_sticker_special_multiproduct == '1') { ?>
                <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_yes; ?></option>
                <?php } ?>
                <?php if ($config_sticker_special_multiproduct == '0') { ?>
                <option value="0" selected="selected"><?php echo $text_no; ?></option>
                <?php } else { ?>
                <option value="0"><?php echo $text_no; ?></option>
                <?php } ?>
              </select></td>
			  <td class="center"><select name="config_sticker_new_multiproduct">
                <?php if ($config_sticker_new_multiproduct == '1') { ?>
                <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_yes; ?></option>
                <?php } ?>
                <?php if ($config_sticker_new_multiproduct == '0') { ?>
                <option value="0" selected="selected"><?php echo $text_no; ?></option>
                <?php } else { ?>
                <option value="0"><?php echo $text_no; ?></option>
                <?php } ?>
              </select></td>
			  <td class="center"><select name="config_sticker_popular_multiproduct">
                <?php if ($config_sticker_popular_multiproduct == '1') { ?>
                <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_yes; ?></option>
                <?php } ?>
                <?php if ($config_sticker_popular_multiproduct == '0') { ?>
                <option value="0" selected="selected"><?php echo $text_no; ?></option>
                <?php } else { ?>
                <option value="0"><?php echo $text_no; ?></option>
                <?php } ?>
			...
			<tr>
			  <td class="left"><?php echo $entry_sticker_rcategory; ?></td>
			  <td class="center"><select name="config_sticker_special_rcategory">
                <?php if ($config_sticker_special_rcategory == '1') { ?>
                <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_yes; ?></option>
                <?php } ?>
                <?php if ($config_sticker_special_rcategory == '0') { ?>
                <option value="0" selected="selected"><?php echo $text_no; ?></option>
                <?php } else { ?>
                <option value="0"><?php echo $text_no; ?></option>
                <?php } ?>
              </select></td>
			  <td class="center"><select name="config_sticker_new_rcategory">
                <?php if ($config_sticker_new_rcategory == '1') { ?>
                <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_yes; ?></option>
                <?php } ?>
                <?php if ($config_sticker_new_rcategory == '0') { ?>
                <option value="0" selected="selected"><?php echo $text_no; ?></option>
                <?php } else { ?>
                <option value="0"><?php echo $text_no; ?></option>
                <?php } ?>
              </select></td>
			  <td class="center"><select name="config_sticker_popular_rcategory">
                <?php if ($config_sticker_popular_rcategory == '1') { ?>
                <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_yes; ?></option>
                <?php } ?>
                <?php if ($config_sticker_popular_rcategory == '0') { ?>
                <option value="0" selected="selected"><?php echo $text_no; ?></option>
                <?php } else { ?>
                <option value="0"><?php echo $text_no; ?></option>
                <?php } ?>
			...
			<tr>
			  <td class="left"><?php echo $entry_sticker_product_viewed; ?></td>
			  <td class="center"><select name="config_sticker_special_product_viewed">
                <?php if ($config_sticker_special_product_viewed == '1') { ?>
                <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_yes; ?></option>
                <?php } ?>
                <?php if ($config_sticker_special_product_viewed == '0') { ?>
                <option value="0" selected="selected"><?php echo $text_no; ?></option>
                <?php } else { ?>
                <option value="0"><?php echo $text_no; ?></option>
                <?php } ?>
              </select></td>
			  <td class="center"><select name="config_sticker_new_product_viewed">
                <?php if ($config_sticker_new_product_viewed == '1') { ?>
                <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_yes; ?></option>
                <?php } ?>
                <?php if ($config_sticker_new_product_viewed == '0') { ?>
                <option value="0" selected="selected"><?php echo $text_no; ?></option>
                <?php } else { ?>
                <option value="0"><?php echo $text_no; ?></option>
                <?php } ?>
              </select></td>
			  <td class="center"><select name="config_sticker_popular_product_viewed">
                <?php if ($config_sticker_popular_product_viewed == '1') { ?>
                <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_yes; ?></option>
                <?php } ?>
                <?php if ($config_sticker_popular_product_viewed == '0') { ?>
                <option value="0" selected="selected"><?php echo $text_no; ?></option>
                <?php } else { ?>
                <option value="0"><?php echo $text_no; ?></option>
                <?php } ?>
