        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
			...
			<td class="left"><select name="caurusel_all_module[<?php echo $module_row; ?>][filter_type]"  onchange="showCategories(this,<?php echo $module_row; ?>)">
                ...
                <?php } ?>
				<div class="scrollbox" id="scrollbox<?php echo $module_row; ?>" style="min-height:250px;">
					<?php $class = 'odd'; ?>
...
function addModule() {	
    ...
    html += '    </select>';
	html += '	   <?php echo $entry_scroll; ?><input type="text" name="caurusel_all_module[' + module_row + '][scroll]" value="800" size="3" />';
