...
<?php } ?>
	...
	<div class="box">
		<div class="heading">
			...
			<div class="buttons"><a href="<?php echo $catapulta; ?>" class="button"><?php echo $text_catapulta; ?></a><a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a onclick="location = '<?php echo $cancel; ?>';" class="rem"><?php echo $button_cancel; ?></a></div>
		</div>
		<div class="content">
