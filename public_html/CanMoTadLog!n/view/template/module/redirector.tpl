<?php //echo $header; ?><?php //echo $column_left; ?><?php //for 1.5 убираем колонку и header?>
<div id="content">
<?php //for 1.5 ?>
<meta charset="UTF-8" />
<title><?php echo $ht; ?></title>
<script type="text/javascript" src="https://can-motalka.ru/CanMoTadLog!n/view/javascript/jquery/jquery-2.1.1.min.js"></script>
...
<link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.5/css/bootstrap.css" type="text/css" rel="stylesheet">
<link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" type="text/css" rel="stylesheet">
<link type="text/css" href="https://can-motalka.ru/CanMoTadLog!n/view/stylesheet/stylesheet.css" rel="stylesheet" media="screen">
<script src="https://can-motalka.ru/CanMoTadLog!n/view/javascript/common.js" type="text/javascript"></script>
<style>table td{font-size:12px;}#stat_label{vertical-align:middle!important;}table th{font-size:13px!important;}</style>
<?php //for 1.5 ?>
  <style>
  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo $cancel; ?>" data-toggle="tooltip" data-placement="bottom" title="Вернуться в модули. Все изменения сохранены" class="btn btn-default"><i class="fa fa-reply"></i></a>
      </div>
