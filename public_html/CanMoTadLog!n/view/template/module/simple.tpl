...
<div class="box">
  <div class="heading">
    ...
    <div class="buttons">
        ...
        <?php } ?>
        <a onclick="$('#form').submit();" class="button"><span><?php echo $button_save; ?></span></a><a onclick="location = '<?php echo str_replace("'", "\\'",$cancel); ?>';" class="rem"><span><?php echo $button_cancel; ?></span></a></div>
  </div>
  <div class="content">
    <div id="tabs" class="htabs simple">
