												...
												<td colspan="2">	
													<div class="scrollbox"> 
														...
														<?php foreach ($categories_info as $categories_in) { ?>
															...
															<?php } ?>
														<?php } ?>
													</div><br /><a onclick="$(this).parent().find(':checkbox').attr('checked', true);" class="add">Выделить все</a> <a onclick="$(this).parent().find(':checkbox').attr('checked', false);" class="rem">Снять выделение</a>
												</td>
											</tr>
											<!-- Товары-->
											<tr>					
