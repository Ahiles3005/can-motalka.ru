...
<?php } ?>
	...
	<div class="box">
		<div class="heading">
			...
			<div class="buttons">
				<a href="<?php echo $clear_cache; ?>" class="rem"><?php echo $button_clear_cache; ?></a>
				<a onclick="$('#form input[name=apply]').val(1); $('a.submit').trigger('click');" class="add"><?php echo $button_apply; ?></a>
				<a onclick="$('#form').submit();" class="button submit"><?php echo $button_save; ?></a>
				<a onclick="location = '<?php echo $cancel; ?>';" class="rem"><?php echo $button_cancel; ?></a>
			</div>
		</div>
		<div class="content">
