...
<div class="box">
  <div class="heading">
    ...
    <div class="buttons">
		<a onclick="apply();" class="add"><?php echo $button_apply; ?></a><a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><?php echo $button_cancel; ?></a><a onclick="emptyTable();" class="button empty"><?php echo $button_empty; ?></a></div>
  </div>
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-links">
			...
			<table class="double_select" style="width: 100%">
				<tr>
					<td>
						<span class="help"><?php echo $text_move_category; ?></span>
						<select multiple="multiple" id="categories" size="10" style="width: 100%;min-height: 700px"></select>
					...
					<td>
						...
						<select multiple="multiple" id="rcategories" size="10" style="width: 100%;min-height: 700px" name=related_categories[]></select>
...
<!-- OWL Carousel Setting Form //-->			
            ...
            <td class="center">
				<a onclick="$('#module-row<?php echo $module_row; ?>').remove();" class="rem"><?php echo $button_remove; ?></a>
			</td>
          </tr>
        </tbody>
        <?php $module_row++; ?>
        ...
        <tfoot>
          <tr>
            <td colspan="10"></td>
            <td class="center"><a onclick="addModule();" class="add"><?php echo $button_add_module; ?></a></td>
          </tr>
        </tfoot>
      </table>
    </form>
...
function addModule() {
	...
	html += '    <td class="center"><a onclick="$(\'#module-row' + module_row + '\').remove();" class="rem"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
