...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('#apply').val(1); $('#form').submit();" class="add"><span><?php echo $button_apply; ?></span></a><a onclick="$('#form').submit();" class="button"><span><?php echo $button_save; ?></span></a><a href="<?php echo $cancel; ?>" class="rem"><span><?php echo $button_cancel; ?></span></a></div>
    </div>
    <div class="content">
