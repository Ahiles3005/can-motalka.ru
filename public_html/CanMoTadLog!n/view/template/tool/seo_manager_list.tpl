        ...
        <table class="list">
          ...
          <tbody>
		    <tr class="filter">
			  ...
			  <td align="right"><a onclick="filter();" class="button">GO</a></td>
			</tr>
            <?php if ($url_aliases) { ?>
