...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="control-unit-page"><?php echo $heading_title; ?></h1>
        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td align="center" width="100"><a class="ajax-status tooltip" id="status-<?php echo $control_unit['control_unit_id']; ?>" title="Вкл\Выкл блок в системе управления"><?php echo $control_unit['status']; ?></a></td>
