...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="coupon-page"><?php echo $heading_title; ?></h1>
      <div class="buttons"><a href="<?php echo $insert; ?>" class="add"><?php echo $button_insert; ?></a><a onclick="document.getElementById('form').submit();" class="rem"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="contentes">
        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td align="center" width="100"><a class="ajax-status tooltip" id="status-<?php echo $coupon['coupon_id']; ?>" title="Вкл\Выкл купон"><?php echo $coupon['status']; ?></a></td>
              <td class="center">
