...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="mail-page"><?php echo $heading_title; ?></h1>
      <div class="buttons"><a id="button-send" onclick="send('index.php?route=sale/contact/send&token=<?php echo $token; ?>');" class="add"><?php echo $button_send; ?></a><a href="<?php echo $cancel; ?>" class="rem"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="contentes">
