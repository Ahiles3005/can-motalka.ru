...
<?php } ?>
  ...
  <div class="box">
        ...
        <table class="list mini">
          <thead>
            <tr>
              ...
              <td class="right d-none"><?php if ($sort == 'o.order_id') { ?>
                <a href="<?php echo $sort_order; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_order_id; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_order; ?>"><?php echo $column_order_id; ?></a>
                <?php } ?></td>
              <td class="left d-none"><?php if ($sort == 'customer') { ?>
                <a href="<?php echo $sort_customer; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_customer; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_customer; ?>"><?php echo $column_customer; ?></a>
                <?php } ?></td>
              <td class="left d-none"><?php if ($sort == 'status') { ?>
              ...
              <td class="left"><?php if ($sort == 'o.date_added') { ?>
                ...
                <?php } ?></td>
              <td class="left d-none"><?php if ($sort == 'o.date_modified') { ?>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;" class="d-none"><?php if ($order['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="right d-none"><?php echo $order['order_id']; ?></td>
              <td class="left d-none"><?php echo $order['customer']; ?></td>
              <td class="left d-none"><?php echo $order['status']; ?></td>
              <td class="right"><?php echo $order['total']; ?></td>
              <td class="left"><?php echo $order['date_added']; ?></td>
              <td class="left d-none"><?php echo $order['date_modified']; ?></td>
              <td class="center">
	...
	<div class="foot_heading">
      <h1 class="sale-page"><?php echo $heading_title; ?></h1>
      <div class="buttons"><a onclick="$('#form').attr('action', '<?php echo $invoice; ?>'); $('#form').attr('target', '_blank'); $('#form').submit();" class="button"><?php echo $button_invoice; ?></a><a href="<?php echo $insert; ?>" class="add"><?php echo $button_insert; ?></a><a onclick="$('#form').attr('action', '<?php echo $delete; ?>'); $('#form').attr('target', '_self'); $('#form').submit();" class="rem d-none"><?php echo $button_delete; ?></a></div>
    </div>
  </div>
</div>
