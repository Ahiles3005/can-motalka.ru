          ...
          <table class="list">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="right">
				  <?php if ($ip['ban_ip']) { ?>
                    <a id="<?php echo str_replace('.', '-', $ip['ip']); ?>" onclick="removeBanIP('<?php echo $ip['ip']; ?>');" class="add"><?php echo $text_remove_ban_ip; ?></a>
                  <?php } else { ?>
                    <a id="<?php echo str_replace('.', '-', $ip['ip']); ?>" onclick="addBanIP('<?php echo $ip['ip']; ?>');" class="rem"><?php echo $text_add_ban_ip; ?></a>
                  <?php } ?>
				</td>
              </tr>
              <?php } ?>
