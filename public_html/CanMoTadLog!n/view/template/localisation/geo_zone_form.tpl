...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="geo-zone-page"><?php echo $heading_title; ?></h1>
        ...
        <table id="zone-to-geo-zone" class="list">
          ...
          <tbody id="zone-to-geo-zone-row<?php echo $zone_to_geo_zone_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#zone-to-geo-zone-row<?php echo $zone_to_geo_zone_row; ?>').remove();" class="rem"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          ...
          <tfoot>
            <tr>
              <td colspan="2"></td>
              <td class="left"><a onclick="addGeoZone();" class="add"><?php echo $button_add_geo_zone; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
