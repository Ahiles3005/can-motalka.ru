...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="currency-page"><?php echo $heading_title; ?></h1>
        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td align="center" width="100"><a class="ajax-status tooltip" id="status-<?php echo $currency['currency_id']; ?>" title="Вкл\Выкл валюту"><?php echo $currency['status']; ?></a></td>
