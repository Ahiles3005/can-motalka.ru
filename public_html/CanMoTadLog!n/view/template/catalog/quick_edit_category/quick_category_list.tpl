...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="page-cat"><?php echo $heading_title; ?></h1>
      <div class="buttons"><a href="<?php echo $repair; ?>" class="button"><?php echo $button_repair; ?></a><a href="<?php echo $insert; ?>" class="add"><?php echo $button_insert; ?></a><a onclick="$('#form').submit();" class="rem"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="contentes">
            ...
            <?php if ($categories) { ?>
              <?php foreach ($categories as $category) { ?>
                <tr>
				  ...
				  <td align="center" width="100"><a class="ajax-status tooltip" id="status-<?php echo $category['category_id']; ?>" title="Вкл\Выкл категорию"><?php echo $category['status']; ?></a></td>
				  <td align="right" class="quick-buttons" width="250">
