...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a href="<?php echo $insert; ?>" class="add"><?php echo $button_insert; ?></a><a onclick="$('#form').attr('action', '<?php echo $copy; ?>'); $('#form').submit();" class="button"><?php echo $button_copy; ?></a><a onclick="$('form').submit();" class="rem"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="contentes">
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list list_product">
          <thead>
            <tr>
              <td class="first_check" style="text-align: center;"><input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" /></td>
              <td class="center table_img"></td>
              <td class="left table_name"><?php if ($sort == 'pd.name') { ?>
                <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                <?php } ?>
				<div class="info-name tooltip" title="<?php echo $text_info_name; ?>"></div></td>
			  <td class="left table_cat"><?php if ($sort == 'p2c.category_id') { ?>
			    ...
			    <?php } ?></td>
              <td class="left table_mod"><?php if ($sort == 'p.model') { ?>
                <a href="<?php echo $sort_model; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_model; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_model; ?>"><?php echo $column_model; ?></a>
                <?php } ?></td>
              <td class="right table_price"><?php if ($sort == 'p.price') { ?>
                <a href="<?php echo $sort_price; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_price; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_price; ?>"><?php echo $column_price; ?></a>
                <?php } ?></td>
              <td class="right table_quant"><?php if ($sort == 'p.quantity') { ?>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td align="center" style="display:none"><a onclick="filter();" class="button_filter tooltip" title="<?php echo $button_filter; ?>"></a></td>
            </tr>
              <?php if ($products) { ?>
				...
				<tr>
				  <td style="text-align: center;"><?php if ($product['selected']) { ?>
					...
					<?php } ?></td>
				  <td class="center quick-buttons" rel="<?php echo $link;?>&edit_image&product_id=<?php echo $product['product_id'];?>">
                    <div>
					...
					<?php if ($this->config->get('config_quick_images') == 1) { ?>
					    <?php if ($product['images']) { ?>		
						  <a style="text-decoration: none;" href="<?php echo $link;?>&product_img&product_id=<?php echo $product['product_id'];?>" class="images_dialog button_images_add tooltip" title="Изменить доп. изображения" /></a>
					    <?php } else { ?>
						 <a style="text-decoration: none;" href="<?php echo $link;?>&product_img&product_id=<?php echo $product['product_id'];?>" class="images_dialog button_images_none_add tooltip" title="У товара отсутствуют доп. изображения, если требуется их добавить, просто нажмите сюда" /></a>
					    <?php } ?>
					  <?php } ?>
					</td>
				  <td class="left break">
				  ...
				  <td align="right" class="prices">
				    <?php if ($product['special']) { ?>
					  <div class="sale tooltip" title="С учетом скидки: <?php echo $product['special']; ?>">sale</div>
					<?php } ?>
				...
				<tr class="no">
				  <td class="quick-buttons" colspan="9">
				  	<div class="quick_name">
					<a class="ajax-status tooltip" id="status-<?php echo $product['product_id']; ?>" title="Включить\отключить товар"><?php echo $product['status']; ?></a>
				    ...
				    <div class="quick-button-icon">
					  ...
					  <?php if ($this->config->get('config_quick_related') == 1) { ?>
					    ...
					    <?php } else { ?>
					      <a style="text-decoration: none;" href="<?php echo $link;?>&product_related&product_id=<?php echo $product['product_id'];?>" class="related_dialog button_related_none tooltip" title="Рекомендуемых нет, нажмите чтобы добавить" /></a>
					    <?php } ?>
					  <?php } ?>
					  ...
					  <?php if ($this->config->get('config_quick_attribute') == 1) { ?>
					    ...
					    <?php } else { ?>
					      <a style="text-decoration: none;" href="<?php echo $link;?>&product_attribute&product_id=<?php echo $product['product_id'];?>" class="attribute_dialog button_attribute_none tooltip" title="Атрибуты отсутствуют, нажмите чтобы добавить" /></a>
					    <?php } ?>
					  <?php } ?>
					  <?php if ($this->config->get('config_quick_options') == 1) { ?>
					    ...
					    <?php } else { ?>
					      <a style="text-decoration: none;" href="<?php echo $link;?>&product_option&product_id=<?php echo $product['product_id'];?>" class="option_dialog button_options_none tooltip" title="Нет опций, нажмите чтобы добавить" /></a>
					    <?php } ?>
					  <?php } ?>
					  <?php if ($this->config->get('config_quick_special') == 1) { ?>
					    ...
					    <?php } else { ?>
					      <a style="text-decoration: none;" href="<?php echo $link;?>&special_price&product_id=<?php echo $product['product_id'];?>" class="special_dialog button_special_none tooltip" title="Товар без акций, нажмите для создания" /></a>
					    <?php } ?>
					  <?php } ?>
