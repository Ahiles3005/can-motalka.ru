...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="page-product"><?php echo $heading_title; ?><span class="heading_name"></span></h1>
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" size="60" name="upc" value="<?php echo $upc; ?>" /></td>
            </tr>
            <tr>
              <td>Ссылка для заказа с Ozon:<br><span class="help">полная с https</span></td>
              <td><input type="text" size="60" name="ozon" value="<?php echo $ozon; ?>" /></td>
            </tr>
            <tr>
        ...
        <div id="tab-attribute">
          <table id="attribute" class="list">
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                ...
                <td class="left"><?php foreach ($languages as $language) { ?>
                  ...
                  <?php } ?></td>
                <td class="left"><a onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="rem"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $attribute_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left"><a onclick="addAttribute();" class="add"><?php echo $button_add_attribute; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  ...
                  <td class="left"><a onclick="$('#option-value-row<?php echo $option_value_row; ?>').remove();" class="rem"><?php echo $button_remove; ?></a></td>
                </tr>
              </tbody>
              ...
              <tfoot>
                <tr>
                  <td colspan="6"></td>
                  <td class="left"><a onclick="addOptionValue('<?php echo $option_row; ?>');" class="add"><?php echo $button_add_option_value; ?></a></td>
                </tr>
              </tfoot>
            </table>
          ...
          <table id="discount" class="list">
            ...
            <tbody id="discount-row<?php echo $discount_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#discount-row<?php echo $discount_row; ?>').remove();" class="rem"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $discount_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="6"></td>
                <td class="left"><a onclick="addDiscount();" class="add"><?php echo $button_add_discount; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <table id="special" class="list">
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              <tr>
                ...
                <td class="left"><a onclick="$('#special-row<?php echo $special_row; ?>').remove();" class="rem"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $special_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="5"></td>
                <td class="left"><a onclick="addSpecial();" class="add"><?php echo $button_add_special; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
        <div id="tab-image">
          <table id="images" class="list">
            ...
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="left"><a onclick="addImage();" class="add"><?php echo $button_add_image; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
...
function addAttribute() {
    ...
    <?php } ?>
	html += '    </td>';
	html += '    <td class="left"><a onclick="$(\'#attribute-row' + attribute_row + '\').remove();" class="rem"><?php echo $button_remove; ?></a></td>';
    html += '  </tr>';	
    html += '</tbody>';
...
$('input[name=\'option\']').catcomplete({
	...
	select: function(event, ui) {
		...
		if (ui.item.type == 'select' || ui.item.type == 'radio' || ui.item.type == 'checkbox' || ui.item.type == 'image') {
			...
			html += '        <td class="left"><a onclick="addOptionValue(' + option_row + ');" class="add"><?php echo $button_add_option_value; ?></a></td>';
			html += '      </tr>';
			html += '    </tfoot>';
			html += '  </table>';
...
function addOptionValue(option_row) {	
	...
	html += '    <td class="left"><a onclick="$(\'#option-value-row' + option_value_row + '\').remove();" class="rem"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
...
function addImage() {
	...
	html += '    <td class="left"><a onclick="$(\'#image-row' + image_row  + '\').remove();" class="rem"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
	html += '</tbody>';
