...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="info-pages"><?php echo $heading_title; ?></h1>
        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td align="center" width="100"><a class="ajax-status tooltip" id="status-<?php echo $information['information_id']; ?>" title="Вкл\Выкл статью"><?php echo $information['status']; ?></a></td>
              <td class="center quick-buttons" width="120">
			    <?php foreach ($information['action'] as $action) { ?>
				  <div class="button-action">
                    ...
                    <a class="button_view tooltip" href="<?php echo HTTP_CATALOG;?>?route=information/info&information_id=<?php echo $information['information_id'];?>" target="_blank" title="<?php echo $text_view; ?>"></a>
				  </div>
				<?php } ?>
			  </td>
            </tr>
