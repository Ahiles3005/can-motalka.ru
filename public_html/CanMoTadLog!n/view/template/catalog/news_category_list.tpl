        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td align="center" width="100"><a class="ajax-status tooltip" title="Вкл/выкл категорию" id="status-<?php echo $news_category['news_category_id']; ?>"><?php echo $news_category['status']; ?></a></td>
              <td class="right quick-buttons" width="250">
