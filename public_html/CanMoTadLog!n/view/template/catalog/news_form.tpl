...
<?php } ?>
  ...
  <div class="box">
    ...
    <div class="contentes">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><!--<a href="#tab-image">Фоновое изображение</a>--><a href="#tab-design"><?php echo $tab_design; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              <td>Ссылка для заказа с Aliexpress:<br><span class="help">полная с https, если не указана, то берется со связанного товара</span></td>
              <td><input type="text" size="60" name="ali" value="<?php echo $ali; ?>" /></td>
            </tr>
            <tr>
              <td>Ссылка для заказа с Ozon:<br><span class="help">полная с https, если не указана, то берется со связанного товара</span></td>
          ...
          <table id="images" class="list">
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr>
                ...
                <td class="left">Рекомендуемое разрешение для фоновой какртинки к статье 1400x280px.<br />Директория для загрузки изображений /image/data/blog-bg/</td>
                <td class="left" style="display:none"><a onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $image_row++; ?>
            <?php } ?>
