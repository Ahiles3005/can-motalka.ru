...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="options-page"><?php echo $heading_title; ?></h1>
            ...
            <tr>
              ...
              <td class="center">
			    <div class="button-action">
				  <a style="text-decoration: none;" href="<?php echo $link;?>&option_edit&option_id=<?php echo $option['option_id'];?>" class="option_dialog button_edites tooltip" title="<?php echo $text_edit; ?>" /></a>
                </div>
			  </td>
            </tr>
            <?php } ?>
