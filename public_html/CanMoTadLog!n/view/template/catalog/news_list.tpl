...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="news-category-page"><?php echo $heading_title; ?></h1>
        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
			  ...
			  <td align="center" width="100"><a class="ajax-news-comments tooltip" title="Вкл/выкл комментарии к этой статье" id="news_comments-<?php echo $article['news_id']; ?>"><?php echo $article['news_comments']; ?></a></td>
			  <td align="center" width="100"><a class="ajax-status tooltip" title="Вкл/выкл статью" id="status-<?php echo $article['news_id']; ?>"><?php echo $article['status']; ?></a></td>
