...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="layout-page"><?php echo $heading_title; ?></h1>
        ...
        <table id="route" class="list">
          ...
          <tbody id="route-row<?php echo $route_row; ?>">
            <tr>
              ...
              <td class="left"><a onclick="$('#route-row<?php echo $route_row; ?>').remove();" class="rem"><?php echo $button_remove; ?></a></td>
            </tr>
          </tbody>
          <?php $route_row++; ?>
          <?php } ?>
          <tfoot>
            <tr>
              <td colspan="2"></td>
              <td class="left"><a onclick="addRoute();" class="add"><?php echo $button_add_route; ?></a></td>
            </tr>
          </tfoot>
        </table>
      </form>
