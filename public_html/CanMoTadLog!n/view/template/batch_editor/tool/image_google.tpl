 ...
 <tfoot>
  ...
  <tr>
   <td class="left" colspan="2"><form id="form-image_google<?php echo $product_id; ?>">
     <p>
      <?php echo $text_folder; ?>: <a onclick="resetFolderImageGoogle('<?php echo $product_id; ?>');">
      <img src="view/batch_editor/image/reset.png" title="<?php echo $text_reset; ?>" alt="<?php echo $text_reset; ?>" />
      </a>
      ...
      <a onclick="$('#form-image_google<?php echo $product_id; ?> select[name=\'image_google[directory][main]\']').after(' <input name=\'image_google[directory][]\' /> <span class=\'separator\'>/</span> ');">
      <img src="view/image/add.png" title="<?php echo $text_add; ?>" alt="<?php echo $text_add; ?>" />
      </a> <a onclick="$('#form-image_google<?php echo $product_id; ?> input[name=\'image_google[directory][]\']:last').remove(); $('#form-image_google<?php echo $product_id; ?> span.separator:last').remove();">
      <img src="view/image/delete.png" title="<?php echo $text_delete; ?>" alt="<?php echo $text_delete; ?>" />
      </a>
     </p>
     <p>
  ...
  <tr>
   <td class="center" colspan="2"><a class="button" onclick="editTool(<?php echo $product_id; ?>, 'image_google', 'add');"><?php echo $text_add; ?></a> <a class="button" onclick="resetImageGoogle(<?php echo $product_id; ?>);"><?php echo $text_reset; ?></a>
    <?php if ($product_id) { ?>
