...
<?php } ?>
 ...
 <div class="box">
  <div class="heading">
   ...
   <div class="buttons">
    <a class="button" onclick="$('#form_setting').submit();"><?php echo $button_save; ?></a> <a class="button" onclick="location = '<?php echo $url_cancel; ?>';"><?php echo $button_cancel; ?></a>
   </div>
  </div>
  <div class="content">
   <form id="form_setting" action="<?php echo $url_action; ?>" method="post">
    <div id="tab-setting" class="htabs">
     <a href="#tab-field"><?php echo $tab_general; ?></a> <a href="#tab-link"><?php echo $tab_link; ?></a> <a href="#tab-filter"><?php echo $tab_filter; ?></a> <a href="#tab-multilanguage"><?php echo $text_language; ?> (<?php echo $text_variables; ?>)</a> <a href="#tab-option"><?php echo $tab_option; ?></a>  <a href="#tab-support">Support</a>
    </div>
    <div id="tab-field">
