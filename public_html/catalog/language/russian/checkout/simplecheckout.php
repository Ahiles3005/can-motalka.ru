...
$_['text_items']                     = '<div class="cartimg"><b>%s</b></div> <div class="cartright">Корзина<br />%s</div>';
$_['text_empty']                     = 'В корзине совершенно пусто';
...
$_['error_stock']                    = 'Некоторых товаров нет в наличии';
$_['error_minimum']                  = 'Минимальное количество для заказа товара %s составляет %s!';
$_['error_agree']                    = 'Примите <a href="/politika-konfidencialnosti/" target="_blank" rel="noopener noreferrer">условия соглашения</a>';
...
$_['error_no_payment']               = 'Оплата по данному адресу невозможна! Обратитесь к <a href="%s">Администрации</a>!';
$_['error_min_amount']               = 'Минимальная сумма для заказа составляет %s';
