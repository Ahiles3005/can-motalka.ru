...
<script type="text/javascript" src="/catalog/view/javascript/jquery/socnetauth2-jquery-mask.js"></script>
...
<tr>
	<td width=80></td>
	<td><input type="checkbox" name="agree" value="1"
	checked
	><?php echo $entry_agree; ?> 
	<a href="<?php echo $inf['href']; ?>" target=_blank><?php echo $inf['title']; ?></a>
...
<script> 
  $('input[name="telephone"]').mask('<?php echo $telephone_mask; ?>');
</script> 
<?php } ?>
<?php /* end 1409 */ ?>