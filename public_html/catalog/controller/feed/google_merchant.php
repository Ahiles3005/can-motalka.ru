...
class ControllerFeedGoogleMerchant extends Controller {
	...
	public function index() {
		...
		$this->load->model('feed/google_merchant');
		...
		$products = $this->model_feed_google_merchant->getProducts();
		...
		foreach ($products as $product) { 
			...
			$output .= '<link>' . $this->url->link('product/product', 'product_id=' . $product['product_id']) . '</link>' . $this->eol;
			$output .= '<g:image_link>' . HTTP_IMAGE . 'g_merch/merch.jpg</g:image_link>' . $this->eol;
