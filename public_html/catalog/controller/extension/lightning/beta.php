...
function Wdh($Mhj){if(strpos($Mhj,"product_id = '"))return false;$Mfs=Wc_("config")->get("config_store_id");if(!$Mfs)$Mfs="0";$Mhj=str_ireplace("AND p2s.store_id = '".$Mfs."'","",$Mhj);$Mhj=str_ireplace("AND p2s.store_id = ".$Mfs,"",$Mhj);if(stripos($Mhj,"store_id"))return false;$Mhj=Wau(" LEFT JOIN ".DB_PREFIX."product_to_store p2s ON (*)","",$Mhj);$Mhj=Wau("LEFT JOIN `".DB_PREFIX."product_to_store` p2s ON (*)","",$Mhj);return$Mhj;}
