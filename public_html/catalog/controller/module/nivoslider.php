...
class ControllerModuleNivoSlider extends Controller {
	protected function index($setting) {
		...
		if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/resp_nivoslider/resp_nivoslider.css?v=' .$this->data['timeModified'] = time(). '')) {
			$this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/resp_nivoslider/resp_nivoslider.css?v=' .$this->data['timeModified'] = time(). '');
		} else {
