...
class ControllerNewsNews extends Controller {
	...
	public function index() { 
		...
		if ($news_info) {
			...
			if ($news_info['ali']) {$this->data['ali'] = $news_info['ali'];};
			if ($news_info['ozon']) {$this->data['ozon'] = $news_info['ozon'];};
			...
			if ($this->request->get['news_id'] == 53 && file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/news/news_id_53.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/news/news_id_53.tpl';
			} else if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/news/news.tpl')) {
