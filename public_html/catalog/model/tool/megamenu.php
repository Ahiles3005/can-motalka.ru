<?php
class ModelToolMegamenu extends Model {
	...
	public function parseProduct($item){
		...
		$thumb = $this->model_tool_image->resize('no_image.jpg', $width, $height);			
		}
...
public function aasort (&$array, $key) {
	...
	public function parseCategory($item){
		...
		$thumb = $this->model_tool_image->resize($category['image'], 70, 70);
		} else {
		$thumb = $this->model_tool_image->resize('no_image.jpg', 70, 70);			
		}
		}		
