...
<?php } ?>
  ...
  <div class="box">
    <div class="heading">
      <h1 class="setting-page"><?php echo $heading_title; ?><span class="storename"></span></h1>
      <div class="buttons fl-n"><a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a href="<?php echo $cancel; ?>" class="rem"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="contentes">
      <div id="settabs" class="settabs d-none"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-store"><?php echo $tab_store; ?></a><a href="#tab-local"><?php echo $tab_local; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-product"><?php echo $text_product; ?></a><a href="#tab-category"><?php echo $text_category; ?></a><a href="#tab-manufacturer"><?php echo $text_manufacturer; ?></a><a href="#tab-news"><?php echo $text_news; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-ftp"><?php echo $tab_ftp; ?></a><a href="#tab-mail"><?php echo $tab_mail; ?></a><a href="#tab-fraud"><?php echo $tab_fraud; ?></a><a href="#tab-server"><?php echo $tab_server; ?></a><a href="#tab-other"><?php echo $tab_other; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general" class="settabs-content">
	...
	$("#colorpicker, #colorpicker1, #colorpicker2, #colorpicker3").spectrum({
		...
		showAlpha: true
          ...
          <table class="form">
            ...
            <tr class="d-none">
              <td><?php echo $entry_order_text; ?></td>
              <td><textarea name="config_order_text" style="resize:vertical" cols="40" rows="10"><?php echo $config_order_text; ?></textarea></td>
            </tr>
            <tr class="d-none">
			...
			<tr>
              <td><?php echo $entry_compinfo; ?></td>
              <td><textarea name="config_compinfo" cols="40" rows="5"><?php echo $config_compinfo; ?></textarea></td>
            </tr>
            <tr>
              <td><?php echo $entry_cmap; ?></td>
              <td><textarea name="config_cmap" cols="40" rows="5"><?php echo $config_cmap; ?></textarea></td>
            </tr>
			<tr>
              <td><?php echo $entry_contactem; ?></td>
              <td><textarea name="config_contactem" cols="40" rows="5"><?php echo $config_contactem; ?></textarea></td>
            </tr>
			<tr class="d-none">
        ...
        <div id="tab-store" class="settabs-content">
          <table class="form">
            <tr class="d-none">
        ...
        <div id="tab-local" class="settabs-content">
          <table class="form">
            <tr class="d-none">
        ...
        <div id="tab-option" class="settabs-content">
          ...
          <h2 class="d-none"><?php echo $text_voucher; ?></h2>
          ...
          <h2 class="d-none"><?php echo $text_tax; ?></h2>
          <table class="form d-none">
            <tr>
          ...
          <h2 class="d-none"><?php echo $text_account; ?></h2>
          <table class="form d-none">
            <tr>
          ...
          <h2 class="d-none"><?php echo $text_checkout; ?></h2>
          <table class="form d-none">
            <tr>
          ...
          <h2 class="d-none"><?php echo $text_stock; ?></h2>
          <table class="form d-none">
            <tr>
          ...
          <h2 class="d-none"><?php echo $text_affiliate; ?></h2>
          <table class="form d-none">
            <tr>
          ...
          <h2 class="d-none"><?php echo $text_return; ?></h2>
          <table class="form d-none">
            <tr>
		...
		<div id="tab-category" class="settabs-content">
			<table class="form d-none">
			  <tr>
		...
		<div id="tab-manufacturer" class="settabs-content">
          <table class="form d-none">
            <tr>
		...
		<div id="tab-news" class="settabs-content">
          <table class="form d-none">
            <tr>
        ...
        <div id="tab-image" class="settabs-content">
          <table class="form">
            <tr>
        ...
        <div id="tab-ftp" class="settabs-content">
          <table class="form d-none">
            <tr>
        ...
        <div id="tab-mail" class="settabs-content">
          <table class="form d-none">
            <tr>
        ...
        <div id="tab-fraud" class="settabs-content">
          <table class="form d-none">
            <tr>
        ...
        <div id="tab-server" class="settabs-content">
          <table class="form">
            <tr class="d-none">
		  ...
		  <table>
		  <h2>Google remarketing и merchant</h2>
		<tr>
              <td><?php echo $entry_remarketing_code; ?><br /><br />
			  <?php echo $text_link_remarketing; ?></td>
              <td style="vertical-align:top"><input type="text" name="config_remarketing_code" value="<?php echo $config_remarketing_code; ?>" placeholder="" id="input-remarketing_code" class="form-control" />
		 </td>
         </tr>
		  </table>
<h2>Google reCaptcha</h2>
		...
		<div id="tab-other" class="settabs-content">
          <table class="form">
		    <tr class="d-none">
...
<style>
.cssload-loader,.luma,.wrapper{position:absolute}.luma{width:100%;height:170px;left:0;top:calc(50% - 85px);z-index:12;display:flex;flex-direction:row;align-items:center;flex-wrap:wrap;justify-content:center}.luma .luma-icon,.luma .on{line-height:170px;position:relative;flex-basis:55%;text-align:left;margin:0;font-size:80px;color:#999}.luma .luma-icon{line-height:200px;color:#999;text-align:right;padding:0 40px 0 0;flex-basis:45%;font-size:100px}.luma .luma-icon:before{font-family:lumarkticon;content:"\e900"}.l{-webkit-animation:color_change 3s infinite alternate;-moz-animation:color_change 3s infinite alternate;-ms-animation:color_change 3s infinite alternate;-o-animation:color_change 3s infinite alternate;animation:color_change 3s infinite alternate}.u{-webkit-animation:color_change 5s infinite alternate;-moz-animation:color_change 5s infinite alternate;-ms-animation:color_change 5s infinite alternate;-o-animation:color_change 5s infinite alternate;animation:color_change 5s infinite alternate}.m{-webkit-animation:color_change 2s infinite alternate;-moz-animation:color_change 2s infinite alternate;-ms-animation:color_change 2s infinite alternate;-o-animation:color_change 2s infinite alternate;animation:color_change 2s infinite alternate}.ar{-webkit-animation:color_change 4s infinite alternate;-moz-animation:color_change 4s infinite alternate;-ms-animation:color_change 4s infinite alternate;-o-animation:color_change 4s infinite alternate;animation:color_change 4s infinite alternate}.kt{-webkit-animation:color_change 6s infinite alternate;-moz-animation:color_change 6s infinite alternate;-ms-animation:color_change 6s infinite alternate;-o-animation:color_change 6s infinite alternate;animation:color_change 6s infinite alternate}@-webkit-keyframes color_change{from{color:#f4540f}to{color:#999}}@-moz-keyframes color_change{from{color:#f4540f}to{color:#999}}@-ms-keyframes color_change{from{color:#f4540f}to{color:#999}}@-o-keyframes color_change{from{color:#f4540f}to{color:#999}}@keyframes color_change{from{color:#f4540f}to{color:#999}}
</style>
