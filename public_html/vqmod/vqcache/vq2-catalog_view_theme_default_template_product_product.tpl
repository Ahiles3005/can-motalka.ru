...
<div class="my_floating_buttons">
	<div class="cart-box-action">
		...
		<?php if ($upc && $config_product_button_ali) { ?><a href="<?php echo $upc; ?>" class="btns prod-cart ali<?if ($ozon) {?> my_half<?}?>" target="_blank" rel="noopener noreferrer">Заказать на WB</a><?php } ?>
	</div>
</div>
<style type="text/css">
	.cart-box-action {
  ...
  <link itemprop="url" href="<?php echo $url; ?>">
    ...
    <div class="right">	
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <table class="option-image">
            ...
            <tr>
              ...
              <td><label for="option-value-<?php echo $option_value['product_option_value_id']; ?>"><img src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . strip_tags($option_value['price']) : ''); ?>" /></label></td>
      ...
      <?php if ($upc && $config_product_button_ali) { ?><a href="<?php echo $upc; ?>" class="btns prod-cart ali" target="_blank" rel="noopener noreferrer">Заказать на WB</a><?php } ?>
...
<p class="sp4 bold">*ВНИМАНИЕ! Возможность самовывоза товара уточняйте у менеджера.</p>
  ...
  <div id="tab-review" class="tab-content white">
    ...
    <?php if ($site_key) { ?>
            ...
            <?php } ?><br><a id="button-review" class="button">Добавить</a>
    ...
    <div class="related-box-product">
      ...
      <!-- Категория и производитель -->
		  ...
		  <div class="cart-related">
			<a onclick="addToCart('<?php echo $product['product_id']; ?>', 1, 1);" class="btns c-button"><?php echo $button_cart; ?></a>
		  </div>
		</div>
	  <?php } ?>
	</div>
