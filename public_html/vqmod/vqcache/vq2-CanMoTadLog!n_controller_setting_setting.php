...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_order_text'] = $this->language->get('entry_order_text');
		...
		if (isset($this->request->post['config_order_text'])) {
			$this->data['config_order_text'] = $this->request->post['config_order_text'];
		} else {
			$this->data['config_order_text'] = $this->config->get('config_order_text');
		}
		...
		if (isset($this->request->post['config_fraud_status_id'])) {
			...
			// Remarketing
	  $this->data['text_remarketing'] = $this->language->get('text_remarketing');
	  $this->data['entry_remarketing_code'] = $this->language->get('entry_remarketing_code');
	  $this->data['text_link_remarketing'] = sprintf($this->language->get('text_link_remarketing'), '<a href="'.HTTPS_CATALOG.'index.php?route=feed/google_merchant" target="_blank">'.HTTPS_CATALOG.'index.php?route=feed/google_merchant</a>');
	  
	  if (isset($this->request->post['config_remarketing_code'])) {
	  	$this->data['config_remarketing_code'] = $this->request->post['config_remarketing_code'];
	  } else {
	  	$this->data['config_remarketing_code'] = $this->config->get('config_remarketing_code');
	  }		
	...
	public function template() {
		...
		$this->response->setOutput('<img src="' . $image . '" alt="" title="" />');
	}		
