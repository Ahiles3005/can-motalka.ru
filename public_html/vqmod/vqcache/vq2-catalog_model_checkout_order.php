...
class ModelCheckoutOrder extends Model {	
		...
		public function getOrderRemarketing($order_id) {
			...
			if ($order_query->num_rows) {
				$order_product_query = $this->db->query("SELECT product_id FROM " . DB_PREFIX . "order_product WHERE order_id = '" . (int)$order_id . "'");
				$products = array();
	...
	public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		if ($order_info && !$order_info['order_status_id']) {
			...
			$template->data['text_sku'] = $language->get('text_new_sku');
			...
			$template->data['order_text'] = $this->config->get('config_order_text');
            ...
            if($this->model_module_prosto_sms->isInstalled()){
                $args = [
                    "username" => $order_info['payment_firstname'] . " " . $order_info['payment_lastname'],
                ...
                try {
                    SmsProsto::sendOrderSms($args, $setting);
                }catch (Exception $ex){
                    //silent error
                }
            }
