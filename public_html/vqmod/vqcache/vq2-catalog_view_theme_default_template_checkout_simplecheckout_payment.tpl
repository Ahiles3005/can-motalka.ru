        ...
        <table class="simplecheckout-methods-table">
            <?php foreach ($payment_methods as $payment_method) { ?>
                <tr>
                    ...
                    <td class="title">
						<?php /* start robokassa */ ?>
							<?php if( !empty($payment_method['html_image']) ) { ?>
								<label for="<?php echo $payment_method['code']; ?>"><?php echo $payment_method['html_image']; ?></label>
							<?php } else { ?>
								<label for="<?php echo $payment_method['code']; ?>"><?php if( !empty($payment_method['html_image']) ) { 
			  ?><?php echo $payment_method['html_image']; ?><?php } else { 
			  ?><?php echo $payment_method['title']; ?><?php } ?></label>
						<?php } ?>
						<?php /* end robokassa */ ?>
                    </td>
                </tr>
